...
(astraSmoothScroll = function (e, t) {
  ...
  (() => {
      ...
      if ("off-canvas" === e) {
        ...
        if (s) {
          ...
          for (link = 0, len = c.length; link < len; link++)
            c[link].addEventListener("click", p, !0),
    ...
    "" !== (m = null != d ? d.querySelector("#ast-mobile-header") : m) &&
      null !== m &&
      (c = m.dataset.type),
        ...
        f =
          ...
          (astraNavMenuToggle = function (e) {
            if ("undefined" != typeof astraAddon)
              astraNavMenuTogglePro(e, u, c, this);
            else {
              e.preventDefault();
              var e = document.querySelectorAll(
          ...
          /trident/i.test(n[1])
            ? (a = /\brv[ :]+(\d+)/g.exec(k) || [])
            : ("Chrome" === n[1] &&
                null != (a = k.match(/\bOPR|Edge\/(\d+)/))) ||
              ((n = n[2]
                ? [n[1], n[2]]
                : [navigator.appName, navigator.appVersion, "-?"]),
              null != (a = k.match(/version\/(\d+)/i)) && n.splice(1, 1, a[1]),
              "Safari" === n[0] &&
                n[1] < 11 &&
  ...
  jQuery(document).on("click", ".main-header-bar-navigation a", function () {
    jQuery("body").hasClass("ast-main-header-nav-open") &&
      ...
      jQuery(".main-header-bar-navigation.toggle-on")
